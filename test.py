from models import db, User, get_pair_list, get_user_list, \
    clear_all_users, clear_all_pairs, get_user_from_user_id, get_conversation_from_conversation_id, get_message_from_message_id, get_match_from_match_id
...
bob = User("bob", "bob@bob", "I'm just a fun loving guy :D")
description = bob.get_description()
print description
